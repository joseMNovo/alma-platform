...
/**
 * Landing PÚBLICA de una capacitación — /academia/<slug>
 *
 * Es el link que ALMA pone en Instagram y en el pie de los videos. Sin login.
 *
 * Cuelga de /academia, que es una sola ruta: sin sesión muestra la vidriera y
 * con sesión, el módulo. Por eso /academia no pasa por el middleware: una
 * página de difusión que redirige al login no difunde nada.
 *
