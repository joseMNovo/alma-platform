...
export default function TalleresPage() {
    ...
    return (
      <div className="min-h-screen bg-white flex items-center justify-center">
        <div className="text-[#4dd0e1] text-xl flex items-center">
          <svg className="animate-spin -ml-1 mr-3 h-5 w-5 text-[#4dd0e1]" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
  ...
  // Participantes también pueden ver talleres (solo lectura)
  if (!["admin", "voluntario", "participante"].includes(user.role)) {
    return (
