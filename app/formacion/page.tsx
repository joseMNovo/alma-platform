...
/**
 * Academia PÚBLICA — /formacion
 *
 * La vidriera: todas las capacitaciones publicadas, sin sesión. Cada tarjeta
 * lleva a su landing (/formacion/<slug>), que es donde está el temario, el
 * precio y el botón de compra.
 *
 * Vive en /formacion y no en /academia porque /academia es el módulo interno
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="mx-auto max-w-6xl px-4 py-10">
        ...
        {trainings.length === 0 ? (
          ...
          <CatalogoCapacitaciones trainings={trainings} hrefBase="/formacion" />
        )}
